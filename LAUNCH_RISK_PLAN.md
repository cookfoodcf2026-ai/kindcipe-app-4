...
| P0-2 | library-first 穩定 4 卡 + 更快 | ✅ 已完成（library-first 出 4 卡；AI：maxRetries 1 + maxTokens 1600 → ~15-25s；source 跟 button：AI→AI 卡、食譜庫→食譜庫卡，AI 不再 relabel；library loading footer 完成後自動消失）|
