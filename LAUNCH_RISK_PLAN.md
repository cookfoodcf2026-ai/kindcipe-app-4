...
| P0-2 | library-first 穩定 4 卡 + 更快 | ✅ 已完成（library-first 出 4 卡；AI：maxRetries 1 + maxTokens 2200 → JSON 唔截斷少 retry；source 跟 button：AI→AI 卡、食譜庫→食譜庫卡；library loading footer 完成後自動消失；client timeout 45s→90s + 友善超時提示）|
